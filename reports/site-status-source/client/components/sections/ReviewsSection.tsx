  ...
  return (
    <section className="bg-background py-24">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="Reviews"
          title="Orange County neighbors love hosting outdoors again."
          description="From Balboa Island patios to Mission Viejo pool decks, customers rate us 5/5 for fast scheduling, clear communication, and zero-bite evenings."
          centered
        />
