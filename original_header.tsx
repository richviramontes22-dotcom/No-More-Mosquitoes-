...
export const SiteHeader = () => {
  ...
  const handleScheduleOpen = useCallback(
    (source: string) => {
      ...
      // If not on schedule page, navigate to it and then it should scroll or just stay at top
      // Actually, if we are going to use the in-page form, let's navigate there
      if (!user) {
