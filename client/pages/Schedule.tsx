...
const SchedulePage = () => {
  ...
  return (
    <div className="flex flex-col gap-0">
      ...
      <PageHero
        ...
        aside={
          <div className="space-y-4 text-sm text-muted-foreground">
            ...
            <p>
              Call or text <a className="font-semibold text-primary" href="tel:+19492976225">(949) 297-6225</a> and we’ll help pick the right cadence for your yard.
            </p>
          </div>
        }
      >
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button asChild variant="secondary" size="lg" className="bg-muted/70 text-foreground hover:bg-muted">
            <a href="tel:+19492976225">Call our team</a>
          </Button>
        </div>
      </PageHero>
      ...
      <CtaBand title="Questions before scheduling?" href="tel:+19492976225" ctaLabel="Call or text (949) 297-6225" external />
    </div>
  );
};
