...
import { Loader2, LogOut, UserPlus, Gift, CalendarClock } from "lucide-react";
...
/**
 * Minimal, self-contained shell (no AdminLayout) — sales is not an admin
 * role and must not see the admin nav or any admin-only links.
 */
  ...
  return (
    <div className="min-h-screen bg-muted/20">
      <header className="bg-card border-b border-border/60 px-8 py-4 flex items-center justify-between">
        <h1 className="text-lg font-display font-bold">Sales Dashboard</h1>
