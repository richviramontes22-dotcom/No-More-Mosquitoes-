...
export const ChatWidget = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[9999] flex flex-col items-end pointer-events-none">
      ...
      <div
        className={cn(
          "mb-4 w-[calc(100vw-32px)] sm:w-72 transform overflow-hidden rounded-2xl border border-border bg-background shadow-2xl transition-all duration-300 ease-in-out pointer-events-auto",
      ...
      <button
        ...
        className={cn(
          "flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 pointer-events-auto",
