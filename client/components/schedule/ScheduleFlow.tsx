...
// Mock occupied slots
const occupiedSlots = [
  { date: format(addDays(new Date(), 1), "yyyy-MM-dd"), times: ["9:00 AM – 11:00 AM", "1:00 PM – 3:00 PM"] },
  { date: format(addDays(new Date(), 2), "yyyy-MM-dd"), times: ["11:00 AM – 1:00 PM", "3:00 PM – 5:00 PM"] },
  { date: format(addDays(new Date(), 0), "yyyy-MM-dd"), times: ["9:00 AM – 11:00 AM", "11:00 AM – 1:00 PM", "1:00 PM – 3:00 PM", "3:00 PM – 5:00 PM"] }, // Today is fully booked
];
...
// Fallback mock properties "within the system"
...
export const ScheduleFlow = ({ onSuccess, onCancel, initialAddress }: ScheduleFlowProps) => {
  ...
  const fetchProperties = async () => {
    ...
    try {
      ...
      const allProperties = data && data.length > 0 ? data : SYSTEM_MOCK_PROPERTIES;
      ...
      if (!selectedPropertyId) setSelectedPropertyId(SYSTEM_MOCK_PROPERTIES[0].id);
    } finally {
