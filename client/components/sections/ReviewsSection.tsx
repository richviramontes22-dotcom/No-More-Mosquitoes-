...
type Testimonial = { name: string; location: string; rating: number; body: string };

const ReviewsSection = () => {
  const { t } = useTranslation();
  const testimonials = useSiteContentList<Testimonial>("testimonials_list", staticTestimonials);
