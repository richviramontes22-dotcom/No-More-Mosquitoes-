      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 sm:mt-10 grid gap-8 sm:gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          <div className="space-y-6">
            <div className="rounded-[28px] sm:rounded-[32px] border border-primary/15 bg-primary/5 p-6 sm:p-8 text-sm font-semibold uppercase tracking-[0.3em] text-primary">
              {heading}
            </div>
