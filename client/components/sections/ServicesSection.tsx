...
import { useSiteContent, useSiteContentList } from "@/hooks/useSiteContent";
...
const ServicesSection = () => {
  ...
  const cmsIntro = useSiteContent("services_intro");
  const servicesIntro = cmsIntro || t("services.servicesDesc");
  const services = useSiteContentList<ServiceItem>("services_list", staticServices);
  ...
  return (
    <section className="relative overflow-hidden bg-muted/30 py-24">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="Services"
          title={t("services.targetedTreatments")}
